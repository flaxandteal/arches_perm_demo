"""
Django settings for arches_perm_demo project.
"""
...
DATATYPE_LOCATIONS.append('arches_perm_demo.datatypes')
FUNCTION_LOCATIONS.append('arches_perm_demo.functions')
ETL_MODULE_LOCATIONS.append('arches_perm_demo.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('arches_perm_demo.search_components')
...
SECRET_KEY = 'django-insecure-xtech(xj)5g+!_u-3f6*nbj_1hra(m!3*o9e@(jdtn-@t*-le)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_perm_demo.urls"
ROOT_HOSTCONF = "arches_perm_demo.hosts"

DEFAULT_HOST = "arches_perm_demo"
...
ELASTICSEARCH_PREFIX = 'arches_perm_demo'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_perm_demo.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_perm_demo",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = 'arches_perm_demo.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_perm_demo'
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_perm_demo.search.es_mapping_modifier.EsMappingModifier"]
